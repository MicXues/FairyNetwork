...
const config = {
  serverInfo: {
    ...
    serverName: "FairyNetwork" /*Server name*/,
    serverIp:
      "play.fairynetwork.xyz" /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/,
    discordServerID:
      "1129214889207005204" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/,
  },
    ...
    leaders: [
      {
        inGameName: "Ihannn_",
        rank: "Founder",
        skinUrlOrPathToFile: "images/skins/Ihan-skin.png",
        rankColor: "rgba(255, 3, 3, 1)",
      },
    ],
    helpers: [
      {
        inGameName: "_WhyHannnHD",
        rank: "Helper++",
        skinUrlOrPathToFile: "images/skins/rehan-skin.png",
        rankColor: "",
      },
    ],
  },
